...
$APPLICATION->AddHeadScript('/f/1/press-releases/detail.js');
$APPLICATION->SetAdditionalCSS('/f/1/press-releases/detail.css');
...
?>
    ...
    <div class="block second">
        ...
        <p class="date"><?= $arResult['CITY'][$arResult['ELEMENT']['PROP']['CITY']['VALUE']]['NAME'] ?><? if (!empty($arResult['CITY'][$arResult['ELEMENT']['PROP']['CITY']['VALUE']]['NAME'])) echo ','; ?> <?= FormatDateFromDB($arResult['ELEMENT']['ITEM']['ACTIVE_FROM'], 'DD MMMM YYYY'); ?></p>
        ...
        <? if (!empty($arResult['ELEMENT']['PROP']['ENTERPRISE']['VALUE'])): ?>
            <p>
                <? if (!empty($arResult['ENTERPRISE']['DETAIL_PICTURE'])): ?>
                    <a href="<?= $arResult['ENTERPRISE']['DETAIL_PAGE_URL'] ?>"><img
                            src="<?= CFile::GetPath($arResult['ENTERPRISE']['DETAIL_PICTURE']) ?>"></a>
                <? else: ?>
                    <a href="<?= $arResult['ENTERPRISE']['DETAIL_PAGE_URL'] ?>"><?= $arResult['ENTERPRISE']['NAME'] ?></a>
                <? endif; ?>
            </p>
        <? endif; ?>
