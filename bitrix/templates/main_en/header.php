...
<head>
    ...
    $APPLICATION->AddHeadScript('/f/1/min/global/eng.js');
    ?>
    ...
    <link rel="stylesheet" type="text/css" href="/f/1/min/global/social-likes_birman.css">
    <link rel="stylesheet" type="text/css" href="/f/1/min/global/rs.css">
    <link rel="stylesheet" type="text/css" href="/f/1/min/global/main.css">
...
<div id="layout">
    ...
    <div id="content" class="content_1024">
        ...
        <div id="sidebar">
            <? if ($_SERVER['SCRIPT_NAME'] != '/en/search/index.php' && $_SERVER['SCRIPT_NAME'] != '/en/press-center/news/index.php' && $_SERVER['SCRIPT_NAME'] != '/en/press-center/press-releases/index.php'
                && $_SERVER['SCRIPT_NAME'] != '/en/press-center/media-corporation/index.php' && $_SERVER['SCRIPT_NAME'] != '/en/enterprises/index.php'
            ): ?>
                <div class="search">
                    <form action="/en/search/">
                        <input type="text" class="search_field" name="SEARCH_TEXT"
                               value="<?= $_REQUEST['SEARCH_TEXT'] ?>"/>
                    </form>
                </div>
                <div class="all_sait">
                    <span class="pseudo main_menu_btn">Whole site</span>
                </div>
            <? else: ?>
            ...
            <ul class="navigation navigation_medium <?if($_SERVER['SCRIPT_NAME'] != '/index.php'){?>navigation_inner<?}?>">
                ...
                <? if ($_SERVER['REAL_FILE_PATH'] == '/en/products/element.php') { ?>
                    ...
                    <li class="with_icon catalog_civil">
                        <a href="/en/products/civil/">
                            Civil products
                        </a>
                    </li>
                <? } elseif ($_SERVER['SCRIPT_NAME'] == '/en/products/index.php' || $_SERVER['SCRIPT_NAME'] == '/en/products/civil/index.php') { ?>
                    <li class="with_icon enterprises">
                        <a href="/en/enterprises/">
                            Companies USC
                        </a>
                    </li>
                <? } elseif ($_SERVER['SCRIPT_NAME'] == '/en/index.php') { ?>
                    <li class="with_icon catalog_military">
                        <a href="/en/products/">
                            Military products
                        </a>
        ...
        <div id="wrapper">
            ...
            <div id="page" class="page_top_padding page_bg">
                ...
                <div
                    class="block before_wide most_higher <? if ($_SERVER['PHP_SELF'] == '/en/index.php') { ?>top_menu_transparent<? } ?>">
                    <!--top_navigation-->

                    <div class="lang">
                        <div class="item <? if ($_SERVER['SCRIPT_NAME'] == '/en/index.php'): ?>main_no_selected<? endif; ?>">
                            <a href="/">РУС</a>
                        </div>
                        <div class="item selected <? if ($_SERVER['SCRIPT_NAME'] == '/en/index.php'): ?>main_selected<? endif; ?>">
                            <b>ENG</b>
                        </div>
                    </div>
                ...
                <? if ($_SERVER['REQUEST_URI'] != '/en/products/' && $_SERVER['SCRIPT_NAME'] != '/en/products/civil/index.php'
                && $_SERVER['REAL_FILE_PATH'] != '/en/products/element.php' && $_SERVER['REAL_FILE_PATH'] != '/en/enterprises/element.php'
                && $_SERVER['SCRIPT_NAME'] != '/en/index.php' && $_SERVER['REAL_FILE_PATH'] != '/en/press-center/news/element.php'
                && $_SERVER['REAL_FILE_PATH'] != '/en/press-center/press-releases/element.php' && $_SERVER['REAL_FILE_PATH'] != '/en/press-center/media-corporation/element.php'
                && $_SERVER['SCRIPT_NAME'] != '/en/search/index.php'): ?>
